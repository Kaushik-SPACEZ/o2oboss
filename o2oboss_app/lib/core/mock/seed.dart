...
DbState buildSeed(DateTime now) {
  ...
  final vendors = [
    ...
    Vendor(
      ...
      productIds: const ['p_griha', 'p_homam', 'p_wedding_priest', 'p_pooja_items'],
      serviceCities: const ['Vellore', 'Ranipet', 'Chennai'],
      status: AccountStatus.active,
      rating: 4.9,
      responseRate: 99,
    ...
    Vendor(
      id: 'v_liftline',
      companyName: 'LiftLine Elevators',
      contactPerson: 'Karthik Raman',
      phone: '9443022208',
      email: 'service@liftline.in',
      address: '31, Officers Line',
      city: 'Vellore',
      area: 'Gandhi Nagar',
      categoryIds: const ['cat_lifts'],
      productIds: const ['p_home_lift', 'p_passenger_lift', 'p_lift_amc'],
      brandIds: const ['b_otis', 'b_kone'],
      serviceCities: const ['Vellore', 'Ranipet', 'Chennai'],
      status: AccountStatus.active,
      rating: 4.5,
      responseRate: 89,
      ...
      commercialNote: 'Referral fee: 2% of order value',
      commissionPercent: 2,
      documents: [doc('GST certificate.pdf', DocKind.gst, 330)],
      joinedAt: ago(d: 330),
    ),
  ];
  ...
  return DbState(
    ...
    consents: consents,
    waitlist: [
      WaitlistEntry(id: 'W-1', name: 'Ravi Teja', phone: '9848011111', role: UserRole.sales,
          occupation: Occupation.student, age: 20, city: 'Guntur', area: 'Brodipet', createdAt: ago(d: 12)),
      WaitlistEntry(id: 'W-2', name: 'Lakshmi P', phone: '9848022222', role: UserRole.customer,
          city: 'Guntur', area: 'Arundelpet', createdAt: ago(d: 6)),
      WaitlistEntry(id: 'W-3', name: 'Suresh Babu', phone: '9848033333', role: UserRole.vendor,
          city: 'Guntur', area: 'Lakshmipuram', createdAt: ago(d: 3)),
      WaitlistEntry(id: 'W-4', name: 'Kavitha S', phone: '9842044444', role: UserRole.sales,
          occupation: Occupation.homemaker, age: 34, city: 'Madurai', area: 'Anna Nagar', createdAt: ago(d: 2)),
    ],
    seq: {
      'waitlist': 4,
      'enquiry': 1034,
